...
public class Menu extends Tela{
    public Menu (Frame frame) {
        ...
        ImageIcon bgImage = new ImageIcon(this.getClass().getResource("./../imagens/menu.png"));
        ...
        ImageIcon bgSelecionar = new ImageIcon(this.getClass().getResource("./../imagens/botoes/selecionar.png"));
